...
```
DFIR             Memory forensics (Volatility 3) · Disk imaging (dd) · Log & artefact analysis
                 Malware triage · Ghidra (static analysis) · Timeline reconstruction · Chain of custody
